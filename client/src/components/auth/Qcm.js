        ...
        <div className='register   '>
            <Message className=''>
                <Message.Header >    
                    ...
                    كورونا المستجد.</h4>
                    <p>
                        ويقدم الفحص الذي يأتي في إطار المساهمة في مكافحة انتشار هذا الوباء،
                        ...
                        نستطيع تقييم الحالة وتقديم النصيحة الطبية وما يترتب على ذلك تجاه أي مؤشرات تدل على الإصابة بكوفيد-19 والتي يمكن
                        أن تظهر حتى 14 يوما بعد الإصابة بالفيروس.
                    </p>
                </Message.Header>
